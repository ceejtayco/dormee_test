@extends('layouts.app')
@section('custom-css')
<link rel="stylesheet" href="{{ asset('css/maps/add_dorm.css') }}" type="text/css">
@endsection
@include('static.header')
@section('content')

<!-- Hero section -->
<section class="hero-section set-bg" data-setbg="{{asset('public/img/bg.jpg')}}" style="background-attachment: fixed; 
...
<section class="properties-section spad">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="propertie-item set-bg" data-setbg="{{asset('public/img/propertie/1.jpg')}}">
			...
			<div class="col-md-6">
				<div class="propertie-item set-bg" data-setbg="{{asset('public/img/propertie/2.jpg')}}">
					<div class="rent-notic">Available</div>
					<div class="propertie-info text-white">
						<div class="info-warp">
							<h5>C5 Dormitel</h5>
	...
	<!-- Review section -->
	<section class="review-section set-bg" data-setbg="{{asset('public/img/review-bg.jpg')}}">
		<div class="container">
			<div class="review-slider owl-carousel">
				<div class="review-item text-white">
					...
					<div class="clint-pic set-bg" data-setbg="{{asset('public/img/review/1.jpg')}}"></div>
				</div>
				<div class="review-item text-white">
					<div class="rating">
						<i class="fa fa-star"></i>
